class Article < ActiveRecord::Base
  ...
  class << self
    def generate
      ...
      create! title: a_title, intro: a_intro, content: a_content
    end
  end

  def update_authors
    Author.where(id: author_ids).update_all('articles_count = articles_count - 1')
  end
end
